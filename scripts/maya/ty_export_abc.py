...
Release Note:
    * v0.0.2 2024-12-21 Tatsuya Yamagishi
	     * Updated : 色々
...
# Settings
#=======================================#
EXPROT_ABC_FILEPATH = 'D:/temp/usd_ac2024/06_legacy/asset/MoxRig/SHARE/geo/MoxRig_look_v0001.abc'
...
def main():
    set_attrs()
    export_abc(EXPROT_ABC_FILEPATH, attrs=sorted(ATTR_DICT))
